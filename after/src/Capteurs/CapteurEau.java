...
public class CapteurEau extends Capteur {
    ...
    public CapteurEau(String code, TypeMesure typeMesure, PlageSeuils plageSeuils) {
        this(code, "INCONNUE", typeMesure, plageSeuils);
    }

    public CapteurEau(String code, String zone, TypeMesure typeMesure, PlageSeuils plageSeuils) {
        super(code, zone);
