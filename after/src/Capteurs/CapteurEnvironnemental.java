...
public class CapteurEnvironnemental extends Capteur {
    ...
    public CapteurEnvironnemental(String code, TypeMesure typeMesure, PlageSeuils plageSeuils) {
        this(code, "INCONNUE", typeMesure, plageSeuils);
    }

    public CapteurEnvironnemental(String code, String zone, TypeMesure typeMesure, PlageSeuils plageSeuils) {
        super(code, zone);
